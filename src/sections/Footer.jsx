...
const Footer = () => {
  return (
    <footer>
      <div className="max-container justify-between items-start gap-20 flex-wrap max-lg:flex-col">
      <div className="flex flex-col items-start">
          <a href="/"> <img src={footerLogo} alt="nike logo" width={150} height={46} /> </a>
        ...
        <div className="flex flex-1 justify-between lg:gap-10 gap-20 flex-wrap" >
          {footerLinks.map((section) => (
            <div key={section}>
              <h4 className="text-white mt-8 font-montserrat text-2xl leading-normal font-medium mb-6 ">{section.title}</h4>
              <ul>
